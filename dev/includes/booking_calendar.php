...
?>
                 ...
                 else
                 {
                    ...
                    else 
                    {
                        ...
                        $.Dialog({
                              ...
                              padding : 20,
                              title: 'Confirmation', 
                              content : 'Souhaitez-vous appliquer la modification Ã  un seul événement ou Ã  toute la collection ?<br><br><div style="margin:auto;text-align:center;"><input type="submit" value="Unique" onclick="upStart(\'unique\',\''+start+'\',\''+end+'\',\''+id+'\');" />    <input type="submit" value="Tous" onclick="upStart(\'all\',\''+start+'\',\''+end+'\',\''+id+'\');" /></div>',
                              sysButtons:{
                                  btnClose : true
                              }  
                          });
        ...
        else 
        {
            //Aggregation d'events, demander confirmation si modif unique ou aggreg
              $.Dialog({
                    ...
                    padding : 20,
                    title: 'Confirmation', 
                    content : 'Souhaitez-vous appliquer la modification Ã  un seul événement ou Ã  toute la collection ?<br><br><div style="margin:auto;text-align:center;"><input type="submit" value="Unique" onclick="del(\'unique\',\''+selectedEvent+'\');" />    <input type="submit" value="Tous" onclick="del(\'all\',\''+selectedEvent+'\');" /></div>',
                    sysButtons:{
                        btnClose : true
                    }
    ...
    function checkBook()
    {
    	...
    	switch (errorCode)
    	{
    		...
    		//Erreur de quota
    		case "2":
	    		content = "Erreur : Vous avez déjÃ  une réservation cette semaine.";
    		break;
    		//Erreur inconnue
    		case "3":
                ...
                if ($_SESSION['isAdmin']==true)
                {
                    echo '<div id="recurrent" style="display:none;width:90%;">
                           ...
                           <select id="bookNameSelect" style="margin-left:129px;">
                                ...
                                <option value="EntraÃ®nement équipe 1">EntraÃ®nement équipe 1</option>
                                <option value="EntraÃ®nement adultes">EntraÃ®nement adultes</option>
                                <option value="Sport adapté">Sport adapté</option>
                                <option value="Match amical">Match amical</option>
                                <option value="Stage">Stage</option>
                                <option value="Ã‰cole de tennis">Ã‰cole de tennis</option>
                                ...
                                <option value="Ã‰coles primaires">Ã‰coles primaires</option>
                           </select>
                           <br>
